...
PKG_SOURCES	=  tclsndfile.c
PKG_OBJECTS	=  tclsndfile.o
...
PKG_LIB_FILE	= libsndfile1.0.so
PKG_LIB_FILE8	= libsndfile1.0.so
PKG_LIB_FILE9	= libtcl9sndfile1.0.so
PKG_STUB_LIB_FILE = libsndfilestub1.0.a
...
top_builddir	= /home/danilo/Public/tclsndfile
